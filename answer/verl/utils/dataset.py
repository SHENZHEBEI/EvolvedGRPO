...
class RLHFDataset(Dataset, ImageProcessMixin):
    ...
    def __init__(
        ...
        self.dataset.remove_columns("none")

        self.dataset = self.dataset.add_column("id", [d["id"] for d in obj])
        self.dataset = self.dataset.add_column("problem", [d["problem"] for d in obj])
        self.dataset = self.dataset.add_column("answer",  [d["answer"] for d in obj])
        self.dataset = self.dataset.add_column("image",   [(data_path + "/" + d["image"]) for d in obj])
